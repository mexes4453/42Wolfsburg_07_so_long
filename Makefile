...
#    Updated: 2022/09/03 03:59:15 by cudoh            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

#SRCS:= $(shell ls *.c | grep -v lst | xargs)
SRCS:= main.c queue_utils.c \
		map_a_utils.c map_b_utils.c map_c_utils.c map_d_utils.c\
		nav_a_utils.c nav_b_utils.c \
		app_a_utils.c app_b_utils.c app_c_utils.c app_d_utils.c app_e_utils.c\
		app_f_utils.c \
...
all : $(NAME)
$(NAME) : $(OBJS) $(USR_LIB)
	@echo "\033[1;33mCompiling Executables: so_long \033[0m"
